...
namespace StoreFront.UI.MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,ProductType,Price,UnitsSold,StatusID,ProductImage")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,ProductName,ProductType,Price,UnitsSold,StatusID,ProductImage")] Product product)
        {
            if (ModelState.IsValid)
            {
